...
class TestFileAccess(unittest.TestCase):
    ...
    def test_get_share(self, file_name):
        ...
        self.assertIsInstance(sinfo.get_item_type(), basestring)
        self.assertIsInstance(sinfo.get_item_source(), int)
        self.assertIsNone(sinfo.get_parent())
        ...
        self.assertIsInstance(sinfo.get_stime(), int)
        self.assertIsNone(sinfo.get_expiration())
        self.assertIsInstance(sinfo.get_token(), basestring)
        self.assertIsInstance(sinfo.get_storage(), int)
        self.assertIsInstance(sinfo.get_mail_send(), int)
